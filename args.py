...
def get_args_parser():
    ...
    parser.add_argument(
        "--siq2_val_csv_path",
        default=os.path.join(DATA_DIR, name2folder["siq2"], "val.csv"),
    )
    parser.add_argument(
        "--siq2_test_csv_path",
        default=os.path.join(DATA_DIR, name2folder["siq2"], "test.csv"),
    )
    parser.add_argument(
        "--siq2_subtitles_path",
        default=os.path.join(DATA_DIR, name2folder["siq2"], "subtitles.pkl"),
    )
    parser.add_argument(
        "--vqa_features_path",
